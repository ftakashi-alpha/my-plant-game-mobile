    ...
    <div style={styles.app}>
      ...
      <div style={styles.twoColumn}>
        <section style={styles.card}>
          ...
          <p style={styles.text}>
            先に防除手段を選び、次に区画をクリックすると防除が実施されます。範囲型はクリック区画を中心に最大9区画へ自動的に影響します。単一区画型はクリック区画のみに作用します。緑枠・継続＝防除効果が継続中の区画です。
          </p>
          ...
          <div style={styles.buttonLine}>
            ...
            <button style={styles.button} onClick={() => applySelectedTool(toolKey)} disabled={gameOver}>
        ...
        <section style={styles.card}>
          ...
          <p style={styles.text}>
            防除手段をクリックして選択し、その後、圃場区画をクリックすると実施されます。現在選択中：<b>{tool.mark} {tool.name}</b> / 範囲：
